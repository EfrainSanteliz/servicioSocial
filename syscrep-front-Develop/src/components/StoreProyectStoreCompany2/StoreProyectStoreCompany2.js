  ...
  <br /><br />
    <table className="table ">
      ...
      <tbody>
        {this.state.data.map(company=>{
          ...
          <td>{company.pais}</td>
          <td>{new Intl.NumberFormat("en-EN").format(company)}</td>
          <td>
                <button className="btn btn-primary" onClick={()=>{this.seleccionarEmpresa(company); this.modalInsertar()}}><FontAwesomeIcon icon={faEdit}/></button>
                {"   "}
                <button className="btn btn-danger" onClick={()=>{this.seleccionarEmpresa(company); this.setState({modalEliminar: true})}}><FontAwesomeIcon icon={faTrashAlt}/></button>
                </td>
          </tr>
          )
        })}
    ...
    <Modal isOpen={this.state.modalInsertar}>
          ...
          <Modal isOpen={this.state.modalEliminar}>
            <ModalBody>
               Estás seguro que deseas eliminar a la empresa {form && form.name}
            </ModalBody>
            <ModalFooter>
