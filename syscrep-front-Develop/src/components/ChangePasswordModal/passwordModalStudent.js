...
const PasswordModalStudent = ({ show, handleClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(process.env.REACT_APP_API_URL+'student/change-password/'+alumno, {
        method: 'PUT',
        headers: {
...
export default PasswordModalStudent;